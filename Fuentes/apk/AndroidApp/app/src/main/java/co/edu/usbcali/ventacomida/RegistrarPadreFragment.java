...
//        }
        ...
        if(TextUtils.isEmpty(txtDireccion.getText().toString())) {
            txtTelefono.setError(mensajeError.replace("$", "Dirección"));
...
//        mProgressView = view.findViewById(R.id.);
        ...
        txtnumIdentificacion = view.findViewById(R.id.inText_num_direccion);
    ...
    public class ServiceSavePadre extends AsyncTask<Boolean,Integer,Void>
    {
