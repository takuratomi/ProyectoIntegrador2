...
public class Bebida implements java.io.Serializable {
	...
	public Bebida(BigDecimal id, String nombre, String descripcion, String estado, String usuarioCreacion,
			Date fechaCreacion, String usuarioModifica, Date fechaModifica, Set<MenuSemana> menuSemanas) {
		this.id = id;
		this.nombre = nombre;
