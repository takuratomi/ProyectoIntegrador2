...
public class Pedido implements java.io.Serializable {
	...
	public Pedido(BigDecimal id, Pago pago, Padre padre) {
		this.id = id;
		this.pago = pago;
		this.padre = padre;
	}

	public Pedido(BigDecimal id, Pago pago, Padre padre, Long idAlmuerzo, Date fechaPedido, Date fechaEntrega,
	...
	public Long getIdAlmuerzo() {
		return this.idAlmuerzo;
	}

	public void setIdAlmuerzo(Long idAlmuerzo) {
		this.idAlmuerzo = idAlmuerzo;
	}
