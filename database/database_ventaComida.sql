create table almuerzo (
  ...
  id_menuSemana    int4 not null, 
  id_hijo          int4 not null, 
  estado           int4, 
...
create table menu_semana (
  id           serial not null, 
  dia          varchar(20), 
  id_principio int4 not null, 
  id_proteina  int4 not null, 
  id_bebida    int4, 
  id_sopa      int4 not null, 
  estado       varchar(1), 
  fecha_inicio date, 
  fecha_fin    date, 
  primary key (id));
...
create table sopa (
  ...
  fecha_modifica   date, 
  primary key (idSopa));
comment on column sopa.idSopa is 'identificador unico de sopa';
...
alter table menu_semana add constraint FKmenu_seman487978 foreign key (id_sopa) references sopa (idSopa);
...
alter table menu_semana drop constraint FKmenu_seman487978;
